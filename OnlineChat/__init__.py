...
from OnlineChat.blueprints.auth import auth_bp
from OnlineChat.blueprints.chat import chat_bp
from OnlineChat.extensions import db, login_manager, csrf, moment
from OnlineChat.models import User, Message
from OnlineChat.settings import config
